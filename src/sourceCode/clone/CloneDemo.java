...
public class CloneDemo 
{
	...
	public static void main(String[] args) throws CloneNotSupportedException
	{
		...
		Employee a = new Employee(1,"Vishal",new Address("Pune","Mahrastra","India"));
		System.out.println("a :"+a);
		System.out.println("Object :"+(a instanceof Object));
		System.out.println("Cloneable :"+(a instanceof Cloneable));
		...
		System.out.println("Same address is reffered in all cloned Objects");
	}
