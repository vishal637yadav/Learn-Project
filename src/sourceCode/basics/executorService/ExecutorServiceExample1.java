package sourceCode.basics.executorService;
...
public class ExecutorServiceExample1
{
	public static void main(String ar[])
	{
		...
		executor.submit(() -> System.out.println("I am Running Task."));
		...
		/*
		 * Before Java 8 executor.submit(new Runnable() {
		 * 
		 ...
		 * System.out.println("I'm Callable task."); return 1 + 1; } });
		 */
		...
		try
		{
			...
			// timeout if the future takes more than 5 seconds to return the
			// result
