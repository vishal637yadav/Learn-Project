...
public enum PlanetEnum
{
	...
	public static void main(String[] args)
	{
		...
		*/
		...
		{	
			...
			System.out.println("000000000000000000000000--->>>>"+p.name());
		}
		
	}
	
	public  PlanetEnum getEnum(double mass)
	{
	...
	{
		return "[name="+this.name()+",mass="+this.getMass()+",radious="+this.getRadius()+"]";
	}
